...
@SpireInitializer
public class AutobattlerRelicMod implements
    ...
    private static final String AUTHOR = "blalo'u, Vex'd"; // And pretty soon - You!
    ...
    public AutobattlerRelicMod() {
      ...
      */
        ...
        AutobattlerRelicDefaultSettings.setProperty(ENABLE_RELIC_START_SETTINGS, "FALSE"); // This is the default setting. It's actually set...
        try {
            SpireConfig config = new SpireConfig("autobattlerRelicMod", "autobattlerRelicConfig", AutobattlerRelicDefaultSettings); // ...right here
            // the "fileName" parameter is the name of the file MTS will create where it will save our setting.
            config.load(); // Load the setting and set the boolean to equal it
            enableRelicStart = config.getBool(ENABLE_RELIC_START_SETTINGS);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = AutobattlerRelicMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = AutobattlerRelicMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT
        String packageName = AutobattlerRelicMod.class.getPackage().getName(); // STILL NO EDIT ZONE
    ...
    public void receivePostInitialize() {
        ...
        ModLabeledToggleButton enableNormalsButton = new ModLabeledToggleButton("Enable starting with the relic, and thereby in Autobattle Mode?",
                350.0f, 700.0f, Settings.CREAM_COLOR, FontHelper.charDescFont, // Position (trial and error it), color, font
                enableRelicStart, // Boolean it uses
                settingsPanel, // The mod panel in which this button will be in
                (label) -> {
                }, // thing??????? idk
                (button) -> { // The actual button:

                    enableRelicStart = button.enabled; // The boolean true/false will be whether the button is enabled or not
                    try {
                        // And based on that boolean, set the settings and save them
                        SpireConfig config = new SpireConfig("defaultMod", "theDefaultConfig", AutobattlerRelicDefaultSettings);
                        config.setBool(ENABLE_RELIC_START_SETTINGS, enableRelicStart);
                        config.save();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
