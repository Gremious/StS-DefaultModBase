...
// =============== CHARACTER CLASS START =================
	...
	public TheDefault(String name, PlayerClass setClass) {
		super(name, setClass, orbTextures,
				...
				new SpriterAnimation("defaultModResources/images/char/defaultCharacter/Spriter/theDefaultAnimation.scml"));
    ...
    // =============== ANIMATIONS =================  
		...
		this.loadAnimation(defaultmod.DefaultMod.makePath(defaultmod.DefaultMod.THE_DEFAULT_SKELETON_ATLAS),
				defaultmod.DefaultMod.makePath(defaultmod.DefaultMod.THE_DEFAULT_SKELETON_JSON), 1.0f);
 ...
 // =============== /CHARACTER CLASS END/ =================
    ...
    public CharSelectInfo getLoadout() {
        return new CharSelectInfo("The Default",
        		"Placeholder description text. NL " +
