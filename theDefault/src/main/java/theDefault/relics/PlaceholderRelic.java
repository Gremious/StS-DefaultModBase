...
public class PlaceholderRelic extends CustomRelic {
    ...
    public static final String IMG = "theDefault/images/relics/placeholder_relic.png";
    public static final String OUTLINE = "theDefault/images/relics/outline/placeholder_relic.png";
